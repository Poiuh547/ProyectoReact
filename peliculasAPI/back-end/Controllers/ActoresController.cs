...
namespace PeliculasAPI.Controllers
{
    ...
    public class ActoresController : ControllerBase
    {
        ...
        public ActoresController(ApplicationDbContext context,
            IMapper mapper,
            IAlmacenadorAzureStorage almacenadorArchivos)
        {
        ...
        {
            var quearyable = context.Actores.AsQueryable();
            await HttpContext.InsertarParametrosPaginacionEnCabecera(quearyable);
            var actores = await quearyable.OrderBy(x => x.Nombre).Paginar(paginacionDTO).ToListAsync();
